...
XFTY supports five insert modes, plus one orthogonal setting that composes
with any of them.
...
normally - see [insert-modes](insert-modes.md#excluding-the-primary---excludeprimaryids).
